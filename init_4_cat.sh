...
python ./traffic-detection.py --names_path=data/obj.names  --desc_path=FullIJCNN2013/ReadMe.txt --in_img_path=FullIJCNN2013 --out_img_path=data/obj --label_path=FullIJCNN2013/gt.txt --list_file_dir=data --is_4_cat=True
